            ...
            if end < df.shape[0]:
                ...
                if save_data == 'test_simple':
                    ...
                    if act_wind_count == 0 :
                        ...
                        tmp_test = tmp_test.ix[:,2:]
                        print 'tmp_test :', tmp_test
                        test_label = -1
                        res_label_index = testing_accuracy(df_test, test_label, pca_, model_ )
                        res_label = act_index_label[res_label_index] 
...
def testing_accuracy(test_data, test_label, pca_train, model_train, get_accuracy = False):
    """
...
if __name__ == '__main__':
    ...
    hdf_file = 'unit_patterns_zhiyuan.h5'
    global pca_
    global model_
    global act_model_
    global act_pca_
    ...
    #activity_file = 'activity_model.pickle'

    #cluster_model_  = pickle.load( open( activity_file, "rb" ) )
